...
SECRET_KEY = 'django-insecure-cmn*=x-kc3*cjtu+o*i^+d*t^3bq!m^fm5r#iy(rb-v6@0m#f3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['covidresearch.pythonanywhere.com', '127.0.0.1', 'imwbs.herokuapp.com', 'imwbs.pythonanywhere.com']
