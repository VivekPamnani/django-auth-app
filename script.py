...
def auto_email():
    ...
    for user in user_list:
        if user.username != 'admin' and user.participant.is_verified:
            ...
            #         body.append("Hi, " + user.username + "! <br><br>This is an email reminder for the follow-up survey. You have completed " + str(user.participant.sessions_completed) + " out of 6 sessions. Please visit the website to earn and participate: https://www.imwbs.org/user/login/")
            ...
            # ):
            #     to_addr.append(user.email)
            #     body.append("Hi, " + user.username + "! <br><br>This is an email reminder for the upcoming follow-up session. You have completed " + str(user.participant.sessions_completed) + " out of 6 sessions. Please visit the website AFTER 2 days to earn and participate: https://www.imwbs.org/user/login/ . We suggest you block your calendar about 2 days from now for a 30 minute slot.")
            #     user.participant.last_email = timezone.now()
            #     user.save()
            ...
            if( rem_time <= datetime.timedelta(days=1) and
                ...
                to_addr.append(user.email)
                body.append("Hi, " + user.username + "! <br><br>This is an email reminder for the upcoming follow-up session. You have completed " + str(user.participant.sessions_completed) + " out of 6 sessions. Please visit the website TOMORROW to earn and participate: https://www.imwbs.org/user/login/ <p>You username is :" + user.username + ".<p>")
                user.participant.last_email = timezone.now()
                user.save()
            ...
            if( rem_time <= datetime.timedelta(hours=3) and
                ...
                to_addr.append(user.email)
                body.append("Hi, " + user.username + "! <br><br>This is an email reminder for the upcoming follow-up session. You have completed " + str(user.participant.sessions_completed) + " out of 6 sessions. Please visit the website any time TODAY to earn and participate: https://www.imwbs.org/user/login/ <p>You username is :" + user.username + ".<p>")
                user.participant.last_email = timezone.now()
                user.save()
            ...
            if( rem_time < datetime.timedelta(hours=-20) and
                ...
                to_addr.append(user.email)
                body.append("Hi, " + user.username + "! <br><br>This is an email reminder for the missed follow-up session. You have completed " + str(user.participant.sessions_completed) + " out of 6 sessions. Please visit the website any time TODAY to earn and participate: https://www.imwbs.org/user/login/ <p>You username is :" + user.username + ".<p>")
                user.participant.last_email = timezone.now()
                user.save()
                send_mail('[Indian Mental Wellbeing Study] Your next session is TODAY.',
                    '',
            ...
            if( rem_time < datetime.timedelta(days=-4, hours=-20) and
                ...
                to_addr.append(user.email)
                body.append("Hi, " + user.username + "! <br><br>This is an email reminder for the missed follow-up session. You have completed " + str(user.participant.sessions_completed) + " out of 6 sessions. Please visit the website any time TODAY to earn and participate: https://www.imwbs.org/user/login/ . Note that is the last email reminder from our side. <p>You username is :" + user.username + ".<p>")
                user.participant.last_email = timezone.now()
                user.save()
                send_mail('[Indian Mental Wellbeing Study] Your next session is TODAY.',
                    '',
